...
<html lang="fi">
  <head>
    ...
    <title>Poista viestejä - Viestiseinä</title>
    ...
    <div class="container">
      <div class="header clearfix">
        ...
        <nav>
          <ul class="nav nav-pills pull-left">
            ...
            <li role="presentation" class="active"><a href="#">Poista viestejä</a></li>
      ...
      <div class="jumbotron">
        <h1>Poista viestejä</h1>
                ...
                <div class="row">
                  ...
                  <?php
                    ...
                    foreach ($tehtävä->msg as $msg) {
                      ...
                      echo '<div class="panel-footer">'.$msg.'</div>';
                      echo '</div>';
                    ...
                    echo '<a href="deleteMsg.php?id='.$viestinumero.'" class="btn btn-danger">Poista</a>';
                    echo '</div>';
                    $viestinumero++;
                   ?>
                </div>
          ...
          <a href="create.php" type="button" class="btn btn-success">Tallenna uusi viesti</a>
        </div>
